                ...
                auth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(UserSignUpActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                Toast.makeText(UserSignUpActivity.this, "Status:" + task.isSuccessful(), Toast.LENGTH_SHORT).show();
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    startActivity(new Intent(UserSignUpActivity.this, UserDetailsActivity.class));
                                    finish();
                                }
                            }
                        });
